...
%
\item<2-> I have \scale~objects, each with weight~$w_i$~\textcolor{gray}{with~$i$ in~$1$ to~\scale}.%
%
...
\begin{itemize}%
\item Find the shortest path that visits~\scale\ locations and returns back to its origin.\cite{ABCC2006TTSPACS,LLRKS1985TTSPAGTOCO}%
\end{itemize}%
%
...
If an algorithm guarantees to always find the \bigmark{5-6}{best-possible} solution for an \npHard\ problem, then its \bigmark{23}{worst-case} runtime will \bigmark{9-20}{grow exponential} with the \bigmark{7-8}{input size~\only<-8,21->{\scale}}\only<9-20>{\bigmark{9-20}{\scale}}.%
}\end{mdframed}%
\makeatother%
}}{0.05}{0.7}%
%
...
\alert{number~\scale\ of cities to visit}%
}}}{0.06666666666}{0.65}%
\locate{8}{\parbox{0.4\paperwidth}{\noindent\centering\Large{%
\alert{number~\scale\ of items to pack}%
}}}{0.53333333333}{0.65}%
%
\locate{22}{\parbox{0.7\paperwidth}{\noindent\centering\textbf{\Large{\alert{%
If we want to get the optimal solution,\\[4pt]it will take too long.%
}}}}}{0.15}{0.45}%
%
\locate{23}{\parbox{0.7\paperwidth}{\noindent\centering\textbf{\Large{%
If we want to get the optimal solution,\\[4pt]it will \alert{sometimes/often/always} take too long.%
}}}}{0.15}{0.45}%
%
...
\locateGraphic{20}{width=0.8\paperwidth}{\sharedDir/graphics/function_growth/function_growth}{0.1}{0.05}%
%
\end{frame}%
%
