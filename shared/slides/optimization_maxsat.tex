...
\begin{itemize}%
%
\item The goal of the \glsFull{optMaxSAT}\cite{HS2005SLSFAA,C1971TCOTPP} problem is to find a setting of \textcolor<2>{red}{$n$~variables} that makes a Boolean formula~$F$ become True. %
