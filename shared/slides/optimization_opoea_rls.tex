...
\begin{itemize}%
\item \gls{algoSLS} with $|S_i|=|N_i|=1$ is the simplest realization of the \gls{metaheuristic} idea.%
\item<2-> \GlsFull{algoRLS} and the \glsFull{algoEAopo} work according to this pattern\cite{DJW2002OTAOTOPOEA,CPD2018TAMPARAOEA}.%
