...
%
\item<3-> Pick up and deliver packages from different places\\to customers using the \alert{least} amount of fuel\cite{WPG2009SRWVRPWEA,WPRGG2009EFTP,WPMG2009OGMEA,PWMG2009IWFLVM}.%
%
\item<4-> Pack a set of things into the \alert{fewest} boxes\cite{ZLWvdBTW2024RLSOT2RBPPWIR,ZWvdBTLTW2024RLSFTDBPAANRFFFA,S2018ITCAPOPMASM,DF1992CAPIPADATAB}.%
%
