...
\only<-8>{\item<5-> \only<-5>{Theory proofs that the worst-case runtime needed to find this tour grows exponentially with the number~$s$ of cities we want to visit.\cite{LLRKS1993SASAAC,CPW1998AROMSCAAA,C1971TCOTPP,K1972RACP,A2008TLOQC}}%
