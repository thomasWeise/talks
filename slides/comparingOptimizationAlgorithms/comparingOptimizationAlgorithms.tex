...
\item<42-> For example, at least half of the papers on the \gls{JSSP} normalize the result qualities they obtain on benchmark instances with the \glsFullpl{BKS}\only<-42>{.}\uncover<43->{ and then compute the arithmetic mean.}%
%
\end{itemize}%
%
\locate{4-39}{%
