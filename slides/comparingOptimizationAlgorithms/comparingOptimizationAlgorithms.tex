...
%
\item<2-> Let's look at the classical \glsFull{optTSP}\cite{ABCC2006TTSPACS,LLRKS1985TTSPAGTOCO,GP2002TTSPAIV,WCLTTCMY2014BOAAOSFFTTSP}.%
...
\item<42-> For example, at least half of the papers on the \glsFull{optJSSP} normalize the result qualities they obtain on benchmark instances with the \glsFullpl{BKS}\only<-42>{.}\uncover<43->{ and then compute the arithmetic mean.}%
%
\end{itemize}%
%
\locate{4-39}{%
