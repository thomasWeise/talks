...
\begin{itemize}%
%
\item \moptipy\cite{WW2023RSDEWASSAA} -- \emph{Metaheuristic Optimization in \python} -- as the name suggests, is a library with implementations of \gls{metaheuristic} optimization methods in \python\cite{programmingWithPython}.%
%
...
%
\item<2-> It could be \emph{\inQuotes{onemax\_20}} for the 20\nobreakdashes-bit \gls{optOneMax} problem, or maybe \emph{\inQuotes{swv15}} for an instance of the \glsFull{optJSSP}, for example.%
%
...
\frametitle{Summary}%
\begin{itemize}%
\item \moptipy\ allows us to conduct replicable self-documenting experiments with \gls{metaheuristic} optimization algorithms in \python.%
