...
%
\item<2-> \alert{Benchmarks}\cite{ZWWW2026WFFAFTSIFGLS,DYHWSB2020BDOHWI}: OneMax\cite{DJW2006UALBFRSHIBBO,M1992HGARWMAH}, LeadingOnes\cite{R1997CPOEA,W1989TGAASPWRBAORTIB}, LinearHarmonic\cite{DYHWSB2020BDOHWI,DJW2002OTAOTOPOEA}, BinInt\cite{TGG1998DCDATSSOP}, Trap\cite{DJW2002OTAOTOPOEA,NB2003AAOTBOSEAOTF}, TwoMax\cite{FQW2018ELDBOAWHTMO,VHGN2002FTTIMEAHSP}, Jump\cite{DJW2002OTAOTOPOEA,FQW2018ELDBOAWHTMO}, Plateau\cite{AD2018PRAFP}, Ising Models\cite{DYHWSB2020BDOHWI,F2004APUBFAMBAOTTDIM,FW2005TODIMMVR}, N-Queens, W-Model%
%
\item<3-> \alert{Baseline}: \glsFull{algoRLS}~(unary operator flips 1~bit), \glsFull{algoEAopo}~(unary operator flips each bit with probability~$1/n$)
%
\item<4-> \alert{SOTA}: Self-Adjusting~$(1+\lambda,\lambda)$~GA, $(1+1)$~FEA
%
\end{itemize}%
\end{frame}%
%
