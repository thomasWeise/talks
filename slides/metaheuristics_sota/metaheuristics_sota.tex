...
a binary-coded \gls{algoEA}\cite{MZB1998ESFLABS}\uncover<8->{ %
...
\begin{itemize}%
\item<11-> for small~$n$ maybe the \gls{algoMA} from\cite{GCF2007AMAFTLABSP}\uncover<12->{, the local search in\cite{HYH2008ESLSFTLABSP}\uncover<13->{, or the branch-and-bound methods from\cite{P2013IBABFLABS,PM2016LABS},}}%
\item<14-> the \gls{algoMA} from\cite{MDW2015NESFLLABS}\uncover<15->{,}%
\item<15-> the self-avoiding walks w/o local search from\cite{BBB2017LABSOIMFARPTAT,BB2018AHAFALABSPWOLAHMF}.%
\end{itemize}%%
}%
\end{itemize}%
\end{frame}%
