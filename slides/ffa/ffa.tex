...
\begin{itemize}%
\item The \glsFull{MaxSAT}\cite{HS2004SLSFAA,C1971TCOTPP} problem is \npComplete~\cite{C1971TCOTPP}.%
...
\item<3-> Let's say you apply AES, RSA, or the Cesar cypher as a function~$g:\naturalNumbersZ\mapsto\naturalNumbersZ$ to~$f$, i.e., do~$g\circ f$.%
