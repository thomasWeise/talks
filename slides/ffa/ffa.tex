...
\item<8-> \alert{They perform identical on ALL of the OneMax-based functions previously.%
from before!}%
\end{itemize}%
\end{frame}%
%
...
\locateGraphic{}{width=0.8\paperwidth}{\sharedDir/graphics/discrete_benchmarks/discrete_benchmarks}{0.1}{0.11}%
\end{frame}%
%
\begin{frame}%
